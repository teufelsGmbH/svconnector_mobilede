...
XML files, be they local or remote. In particular it can be used
to easily get the contents of a RSS feed.
...
(https://github.com/cobwebch/svconnector_mobilede/issues).
